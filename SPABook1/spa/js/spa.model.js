...
spa.model = (function () {
  ...
  //  * update_avatar( <update_avtr_map> ) - send the update_avtr_map to the backend. This results in
  //    an 'spa-listchange' event which publishes the updated people list and avatar information (the css_map
